...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Message.is_mail'
        db.add_column('messaging_message', 'is_mail',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'Message.stream'
        db.alter_column('messaging_message', 'stream_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['messaging.MessageStream']))

    def backwards(self, orm):
        # Deleting field 'Message.is_mail'
        db.delete_column('messaging_message', 'is_mail')
    ...
    models = {
        ...
        'identities.contact': {
            ...
            'related_user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.AccessEntity']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'})
        },
        ...
        'messaging.message': {
            ...
            'is_mail': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'stream': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'stream'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': "orm['messaging.MessageStream']"}),
